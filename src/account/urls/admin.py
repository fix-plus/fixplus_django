...
from src.account.apis.admin.technician_service_card import TechnicianServiceCardListApi, TechnicianServiceCardDetailApi
from src.account.apis.admin.technician_service_zone import TechnicianServiceZoneListApi, TechnicianServiceZoneDetailApi
from src.account.apis.admin.users import UsersListApi, UserDetailAPIView
from src.account.apis.admin.technician_skill import TechnicianSkillListApi, TechnicianSkillDetailApi
