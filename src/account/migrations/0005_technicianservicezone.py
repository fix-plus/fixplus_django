# Generated by Django 4.2.4 on 2025-07-01 08:04
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('account', '0004_alter_technicianstatus_status'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='technician_service_zone', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'abstract': False,
            },
