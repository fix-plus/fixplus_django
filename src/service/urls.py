...
from src.service.apis.assign_to_technician import AssignServiceToTechnicianListApi
...
urlpatterns = [
    ...
    path('<uuid:uuid>/assign-to-technician/', AssignServiceToTechnicianListApi.as_view(), name='assign-to-technician'),
]