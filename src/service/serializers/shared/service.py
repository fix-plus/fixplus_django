...
class OutPutServiceSerializer(serializers.ModelSerializer):
    ...
    def __init__(self, *args, **kwargs):
        ...
        # BaseFields
        base_fields = ['id', 'device_type', 'brand', 'description_for_technician', 'customer_description', 'address', 'status', 'customer', 'assigned_by', 'assigned_at', 'deadline_accepting_at', 'estimate_arrival_at', 'accepted_at']
