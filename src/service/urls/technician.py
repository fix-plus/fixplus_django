...
from src.service.apis.technician.invoice_deduction import TechnicianInvoiceDeductionApi
...
urlpatterns = [
    ...
    path('<uuid:service_id>/invoice-deduction/', TechnicianInvoiceDeductionApi.as_view(), name='technician-invoice-deduction'),
