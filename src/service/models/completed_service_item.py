...
class CompletedServiceItem(BaseModel):
    service = models.ForeignKey(Service, on_delete=models.CASCADE, related_name='completed_service_items', null=False, blank=False)
