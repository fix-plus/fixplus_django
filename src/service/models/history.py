...
class ServiceHistory(BaseModel):
    ...
    previous_status = models.CharField(max_length=30, choices=Service.Status.choices, null=True, blank=True)
    new_status = models.CharField(max_length=30, choices=Service.Status.choices, null=True, blank=True)
